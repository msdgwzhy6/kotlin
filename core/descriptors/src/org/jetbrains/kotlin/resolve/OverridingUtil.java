...
public class OverridingUtil {
    ...
    public OverrideCompatibilityInfo isOverridableByWithoutExternalConditions(
        ...
        OverrideCompatibilityInfo basicOverridability = getBasicOverridability(superDescriptor, subDescriptor);
    ...
    @Nullable
    public static OverrideCompatibilityInfo getBasicOverridability(
            @NotNull CallableDescriptor superDescriptor,
            @NotNull CallableDescriptor subDescriptor
    ) {
